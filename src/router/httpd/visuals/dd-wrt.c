...
//                        nvram_nmatch("0", "%s_nbw", prefix) ? "selected=\\\"selected\\\"" : "");
		...
		if (nvram_nmatch("80", "%s_nbw", prefix)) {	// 802.11ac
			...
			websWrite(wp, "<div class=\"label\"><script type=\"text/javascript\">Capture(wl_basic.channel_wide)</script></div>\n");
			websWrite(wp, "<select name=\"%s_nctrlsb\" >\n", prefix);
			websWrite(wp, "<option value=\"ll\" %s><script type=\"text/javascript\">document.write(wl_basic.upper+\" \"+wl_basic.upper);</script></option>\n",
				  nvram_nmatch("ll", "%s_nctrlsb", prefix) ? "selected=\\\"selected\\\"" : "");
			websWrite(wp, "<option value=\"lu\" %s><script type=\"text/javascript\">document.write(wl_basic.upper+\" \"+wl_basic.lower);</script></option>\n",
				  nvram_nmatch("lu", "%s_nctrlsb", prefix) ? "selected=\\\"selected\\\"" : "");
			websWrite(wp, "<option value=\"ul\" %s><script type=\"text/javascript\">document.write(wl_basic.lower+\" \"+wl_basic.upper);</script></option>\n",
				  nvram_nmatch("ul", "%s_nctrlsb", prefix) ? "selected=\\\"selected\\\"" : "");
			websWrite(wp, "<option value=\"uu\" %s><script type=\"text/javascript\">document.write(wl_basic.lower+\" \"+wl_basic.lower);</script></option>\n",
...
void ej_get_wdsp2p(webs_t wp, int argc, char_t ** argv)
{
	...
	if (nvram_match(nvramvar, "1")) {
		websWrite(wp, "<div class=\"setting\" style=\"margin-top:0.5em\">\n"
...
void ej_get_qosips(webs_t wp, int argc, char_t ** argv)
{
	...
	websWrite(wp, "<tr>\n"	//
		  "<th width=\"50px\"><script type=\"text/javascript\">Capture(share.del)</script></th>\n"	//
...
void ej_get_qosips(webs_t wp, int argc, char_t ** argv)
{
	...
	websWrite(wp, "<tr><td colspan=\"5\"><input type=\"hidden\" name=\"svqos_noips\" value=\"%d\" /></td></tr>", no_ips);
	...
	for (i = 0; i < no_ips && qos_ips && qos_ips[0]; i++) {
		...
		websWrite(wp, "	<td nowrap>\n"
			  "<input name=\"svqos_ipdown%d\" class=\"num\" size=\"5\" maxlength=\"6\" value=\"%s\" style=\"text-align:right;\" %s /> Kbit\n" "</td>\n", i, level2, strcmp(prio, "0") == 0 ? "" : "disabled");
		websWrite(wp, "	<td nowrap>\n" "<input class=\"num\" name=\"svqos_ipup%d\" size=\"5\" maxlength=\"6\" value=\"%s\" style=\"text-align:right;\" %s /> Kbit\n" "</td>\n", i, level,
			  strcmp(prio, "0") == 0 ? "" : "disabled");

		websWrite(wp, "	<td nowrap>\n"
			  "<input name=\"svqos_iplanlvl%d\" class=\"num\" size=\"5\" maxlength=\"6\" value=\"%s\" style=\"text-align:right;\" %s /> Kbit\n"
			  "</td>\n", i, lanlevel, strcmp(prio, "0") == 0 ? "" : "disabled");
...
void ej_get_qosmacs(webs_t wp, int argc, char_t ** argv)
{
	...
	for (i = 0; i < no_macs && qos_macs && qos_macs[0]; i++) {
		...
		websWrite(wp, "<tr>\n"
			  ...
			  "<td><em>%s</em></td>\n"
			  "<td nowrap>\n"
			  "<input name=\"svqos_macdown%d\" class=\"num\" size=\"5\" maxlength=\"6\" value=\"%s\" style=\"text-align:right;\" %s /> Kbit\n"
			  "</td>\n"
			  "<td nowrap>\n"
			  "<input name=\"svqos_macup%d\" class=\"num\" size=\"5\" maxlength=\"6\" value=\"%s\" style=\"text-align:right;\" %s /> Kbit\n"
			  "</td>\n"
			  "<td nowrap>\n"
			  "<input name=\"svqos_maclanlvl%d\" class=\"num\" size=\"5\" maxlength=\"6\" value=\"%s\" style=\"text-align:right;\" %s /> Kbit\n"
			  "</td>\n"
