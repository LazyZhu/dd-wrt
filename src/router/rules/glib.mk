...
glib20-configure:
	cd glib20/libffi && autoconf && ./configure --enable-static --disable-shared --host=$(ARCH)-linux CC="ccache $(CC)" CFLAGS="$(COPTS) -D_GNU_SOURCE -fPIC -Drpl_malloc=malloc"
