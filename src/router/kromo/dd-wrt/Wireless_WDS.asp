...
//]]>
					...
					<input name="%s_wds1_desc" size="27" maxlength="30" value="<%% nvg("%s_wds1_desc"); %%>" />
					<%% get_wdsp2p("1","%s"); %%>
				</div>
...
//]]>
					...
					<input name="%s_wds2_desc" size="27" maxlength="30" value="<%% nvg("%s_wds2_desc"); %%>" />
					<%% get_wdsp2p("2","%s"); %%>
				</div>
...
//]]>
					...
					<input name="%s_wds3_desc" size="27" maxlength="30" value="<%% nvg("%s_wds3_desc"); %%>" />
					<%% get_wdsp2p("3","%s"); %%>
				</div>
				<div class="setting" style="text-align: center">
...
//]]>
					...
					<input name="%s_wds4_desc" size="27" maxlength="30" value="<%% nvg("%s_wds4_desc"); %%>" />
					<%% get_wdsp2p("4","%s"); %%>
				</div>
...
//]]>
					...
					<input name="%s_wds5_desc" size="27" maxlength="30" value="<%% nvg("%s_wds5_desc"); %%>" />
					<%% get_wdsp2p("5","%s"); %%>
				</div>
				<div class="setting" style="text-align: center">
...
//]]>
					...
					<input name="%s_wds6_desc" size="27" maxlength="30" value="<%% nvg("%s_wds6_desc"); %%>" />
					<%% get_wdsp2p("6","%s"); %%>
				</div>
...
//]]>
					...
					<input type="hidden" name="%s_wds7_hwaddr" value="6" />
						...
						<input name="%s_wds7_desc" size="27" maxlength="30" value="<%% nvg("%s_wds7_desc"); %%>" />
						<%% get_wdsp2p("7","%s"); %%>
						</div>
				<div class="setting" style="text-align: center">
...
//]]>
					...
					<input name="%s_wds8_desc" size="27" maxlength="30" value="<%% nvg("%s_wds8_desc"); %%>" />
					<%% get_wdsp2p("8","%s"); %%>
				</div>
				<div class="setting" style="text-align: center">
...
//]]>
					...
					<input name="%s_wds9_desc" size="27" maxlength="30" value="<%% nvg("%s_wds9_desc"); %%>" />
					<%% get_wdsp2p("9","%s"); %%>
				</div>
...
//]]>
					...
					<input name="%s_wds10_desc" size="27" maxlength="30" value="<%% nvg("%s_wds10_desc"); %%>" />
					<%% get_wdsp2p("10","%s"); %%>
				</div>
				</fieldset>
				<br/>
