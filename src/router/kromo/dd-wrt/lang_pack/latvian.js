...
share.firmware="Programmaparatura";
share.time="Laiks";
share.interipaddr="WAN IP adrese";
share.more="Vairak...";
share.help="Palidziba";
share.enable="Iespejot";
share.enabled="Iespejots";
share.disable="Atspejot";
share.disabled="Atspejots";
share.usrname="Lietotajvards";
share.passwd="Parole";
share.hostname="Saimniekdatora vards";
share.vdsl="T-Home VDSL 7 Vlan birkošana";
share.vdslvlan8="VLAN 8 atbalsts";
share.wan_vlantag="Vlan birkas ID";
share.compression="PPP Saspiešana";
share.domainname="Domena vards";
share.wandomainname="WAN Domena vards";
share.landomainname="LAN Domena vards";
share.statu="Statuss";
share.start="Start";
share.end="End";
share.proto="Protokols";
share.ip="IP Adrese";
share.mac="MAC Adrese";
share.none="Neviens";
share.none2="ne";
share.both="Abi";
share.del="Izdzest";
share.remove="Nonemt";
share.descr="Apraksts";
share.from="No";
share.to="Lidz";
share.about="Par";
share.everyday="Katru dienu";
share.sun="Svetdiena";
share.sun_s="Sv";
share.sun_s1="S";
share.mon="Pirmdiena";
...
share.wed_s="Tr";
share.wed_s1="T";
share.thu="Ceturtdiena";
share.thu_s="Ce";
share.thu_s1="C";
share.fri="Piektdiena";
share.fri_s="Pi";
share.fri_s1="P";
share.sat="Sestdiena";
share.sat_s="Se";
...
share.jul="Julijs";
share.aug="Augusts";
share.sep="Septembris";
share.oct="Oktobris";
share.nov="Novembris";
share.dec="Decembris";
share.expires="Beidzies";
share.yes="Ja";
share.no="Ne";
share.filter="Filtrs";
share.deny="Noliegt";
share.range="Diapazons";
share.use="Lietošana";
share.mins="Min.";
share.secs="Sek.";
share.routername="Maršrutetaja vards";
share.manual="Manuals";
share.port="Ports";
share.ssid="SSID";
...
share.rates="atrumi";
share.rate="atrums";
share.txrate="TX atrums";
share.rxrate="RX atrums";
share.low="Zems";
share.medium="Videjs";
share.high="Augsts";
share.option="Opcijas";
share.rule="Noteikums";
share.lan="LAN";
share.point2point="Point to Point";
share.nat="NAT";
share.subnet="Apakštikla maska";
share.unmask="Atmaskot";
share.deflt="Noklusejums";  //don't use share.default!!!
share.all="Visi";
share.auto="Auto";
share.right="Laba";
share.left="Kreisa";
share.share_key="Koplietojama atslega";
share.inter="Intervals (sekundes)";
share.srv="Pakalpojuma nosaukums";
share.port_range="Porta diapazons";
...
share.static_lease="Statiskas nomas";
share.srvip="Servera IP";
share.srvipname="Servera IP/vards";
share.localdns="Lokalais DNS";
share.minutes="Minutes";
share.oui="OUI Meklešana";
share.sttic="Statisks";
share.connecting="Savienoju";
share.connect="Savienot";
share.connected="Savienots";
share.disconnect="Atvienot";
share.disconnected="Atvienots";
share.info="Informacija";
share.state="Statuss";
share.mode="Režims";
share.encrypt="Šifrešana";
share.key="Atslega";
share.wireless="Bezvada";
share.dhcp="DHCP";
share.styl="Stils";
share.err="Kluda";
share.errs="Kludas";
...
share.full="Pilns (20 MHz)";
share.half="Puss (10 MHz)";
share.quarter="Ceturksnis (5 MHz)";
share.seealso="Redzet ari";
share.never="nekad";
share.unknown="Nezinams";
share.expired="beidzies";
share.logout="atteikšanas";
share.nmounted="Nav mountets";
share.fssize="Kopejais / Brivais lielums";
share.src="Avota adrese";
share.dst="Attala adrese";
share.name_resolution="Vardu atrise";
share.timeout="Noildze (s)";
share.detail="Klikšket lai redzetu sikak";
share.tmpmem="Pagaidu atmina";
share._1h="Katru stundu";
share._2h="Katru otro stundu";
share._3h="Katru trešo stundu";
share._4h="Katru ceturto stundu";
share._5h="Katru piekto stundu";
share._6h="Katru sesto stundu";
share._12h="Katru divpadsmito stundu";
share._24h="Katru dienu";
share._48h="Katru otro dienu";
share._168h="Katru nedelu";
share.days="Dienas";
share.from2=share.from;
share.to2=share.to;
share.days_genetive=share.days;
share.standard="Standarts";
share.execscript="Izpildit skriptu";
share.user="Lietotajs";
share.privatekey="Privata atslega";
share.bytes="baiti";
share.kbytes="KB";
share.mbytes="MB";
share.gbytes="GB";
share.preempt="Priekšrociba";
share.acktiming="ACK taimings";
share.broadcast="Apraides atbalsts";
share.secondcharacter="s";


sbutton.save="Saglabat";
sbutton.savetitle="Tikai saglabat iestadijumus bez saskanošanas";
sbutton.apply="Pienemt iestadijumus";
sbutton.applytitle="Pienemt iestadijumus tulit";
sbutton.saving="Saglabats";
sbutton.cmd="Izpildu";
sbutton.cancel="Atcelt izmainas";
sbutton.canceltitle="Atcelt izmainas tikai šini forma";
sbutton.refres="Atsvaidzinat";
sbutton.clos="Slegt";
sbutton.del="Izdzest";
sbutton.continu="Turpinat";
sbutton.add="Pievienot";
sbutton.remove="Nonemt";
sbutton.modify="Modificet";
sbutton.deleted="Izdzests";
sbutton.delall="Izdzest visu";
sbutton.autorefresh="Auto-atsvaidzinašana ieslegta";
sbutton.backup="Dublejums";
sbutton.restore="Rekonstruet";
sbutton.cptotext="Rediget";
sbutton.runcmd="Palaist komandu";
sbutton.startup="Saglabat startu";
sbutton.shutdown="Saglabat izslegšanu";
sbutton.firewall="Saglabat ugunsmuri";
sbutton.custom="Saglabat pielagoto skriptu";
sbutton.wol="Atmoda";
sbutton.add_wol="Pievienot saimniekdatoru";
sbutton.manual_wol="Manuala atmoda";
sbutton.summary="Parskats";
sbutton.filterIP="Rediget klienta sarakstu";
...
sbutton.log_in="Ienakošais žurnals";
sbutton.log_out="Izejošais žurnals";
sbutton.edit_srv="Pievienot/Rediget pakalpojumu";
sbutton.routingtab="Radit maršrutešanas tabulu";
sbutton.wanmac="Radit pašreizejo PC MAC adresi";
sbutton.dhcprel="DHCP atbrivošana";
sbutton.dhcpren="DHCP atjaunošana";
sbutton.survey="WLAN meklešana";
sbutton.upgrading="Jauninaju";
sbutton.upgrade="Jauninajums";
sbutton.preview="Priekšskatijums";
sbutton.allways_on="Vienmer ieslegts";
sbutton.allways_off="Vienmer izslegts";
...
errmsg.err7="Jums jaievada saimniekdatora nosaukums.";
errmsg.err8="Jums jaievada IP adrese jeb domena nosaukums.";
errmsg.err9="Nederiga DMZ IP adrese.";
errmsg.err10="Apstiprinata parole neatbilst ievaditai parolei. Ludzu atkartojiet paroli.";
errmsg.err11="Atstarpe parole nav atlauta.";
errmsg.err12="Jums jaievada komanda palaišanai.";
errmsg.err13="Jauninajums nav paveicies.";
errmsg.err45="Nav izmantojams pa HTTPS! Ludzu savienoties HTTP režima.";
errmsg.err46="Nav izmantojams pa HTTPS";
